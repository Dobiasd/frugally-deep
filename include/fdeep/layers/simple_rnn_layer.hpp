...
namespace internal {
    ...
    class simple_rnn_layer : public layer {
    public:
        explicit simple_rnn_layer(const std::string& name,
            std::size_t n_units,
    ...
    protected:
        tensors apply_impl(const tensors& inputs) const override
        {
            ...
            return simple_rnn_impl(inputs.front(), n_units_, use_bias_,
                return_sequences_, return_state_, weights_,
                recurrent_weights_, bias_, activation_);
        }
