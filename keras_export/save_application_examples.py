...
def main():
    ...
    save_model('densenet201', keras.applications.inception_resnet_v2.InceptionResNetV2(input_shape=(299, 299, 3)))
    save_model('nasnetlarge', keras.applications.mobilenet.MobileNet())
    save_model('mobilenet', keras.applications.densenet.DenseNet201())
    save_model('inceptionresnetv2', keras.applications.nasnet.NASNetLarge())
